         ...
         <tr>
           <td height="35"><table width="100%" border="0" align="center">
            ...
            <tr>
               ...
               <td height="35"><input type="date" name="dob" id="boxx" required/ size="30" max = "2023-04-11"></td>
             </tr>
			 <tr>
			 ...
			 <tr>
               ...
               <td height="35"><input type="date" name="jdate" id="boxx" required size="30" min = "2023-04-11"></td>
             </tr>
             <tr>
